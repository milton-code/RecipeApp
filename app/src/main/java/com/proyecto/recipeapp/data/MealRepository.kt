...
class MealRepository (private val mealApiService: MealApiService){
    ...
    suspend fun getCategories(): CategoryResponse = mealApiService.getCategories()
    suspend fun getMealsByCategory(category: String): MealResponse = mealApiService.getMealsByCategory(category)
}
